...
# write.csv(data.comp.df, "data.comp.metadata.csv", row.names = TRUE)
# data.comp.otu <- as.data.frame(otu_table(data.comp))
# write.csv(data.comp.otu, "data.comp.otu.csv", row.names = TRUE)
# data.comp.tax <- as.data.frame(tax_table(data.comp))
# write.csv(data.comp.tax, "data.comp.tax.csv", row.names = TRUE)

# Reimport ps data.comp
re_otu <- read.csv("data.comp.otu.csv", row.names = 1)
otu_tab <- otu_table(as.matrix(re_otu), taxa_are_rows = T)
re_tax <- read.csv("data.comp.tax.csv", row.names = 1)
tax_tab <- tax_table(as.matrix(re_tax))
re_meta <- read.csv("data.comp.metadata.csv", row.names = 1)
...
writeXStringSet(matched_all_seqs , file = "ASV_export.fasta")
...
SINA_tree <- read.tree("arb-silva.nwk")
...
#SINA_tree2 <- read.tree("arb-silva2.nwk")
